...
public class LinearAlignSource extends ConditionalCommand {
    public LinearAlignSource(Supplier<Pose2d> goalPoseSupplier, Supplier<ChassisSpeeds> chassisSpeedsSupplier, double maxDistance) {
        super(
            new SequentialCommandGroup ( // align
                ...
                new ParallelDeadlineGroup(
                    ...
                    new LinearDriveToPose(() -> AlignmentUtil.offsetSourcePoseToPreAlignment(goalPoseSupplier.get()), () -> chassisSpeedsSupplier.get()) // drive to a intermediate pose                     
                ),
                new ParallelDeadlineGroup(
                    new WaitUntilCommand(
