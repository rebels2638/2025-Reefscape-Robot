...
public class AutoAlign extends Command {
    ...
    private Pose2d targetPose = MechAElementConstants.Reef.centerFaces[0];
    ...
    public void initialize() {
        ...
        for (int i = 0; i < MechAElementConstants.Reef.centerFaces.length; i++) {
            distanceToPose = calculateDistance(currentPose, MechAElementConstants.Reef.centerFaces[i]);
            if (distanceToPose < calculateDistance(currentPose, targetPose)) {
                targetPose = MechAElementConstants.Reef.centerFaces[i];
                closestTarget = targetPose;
            }
        }
