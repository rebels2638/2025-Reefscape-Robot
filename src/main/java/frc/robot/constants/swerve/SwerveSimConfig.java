...
public final class SwerveSimConfig extends SwerveConfigBase {
    public SwerveSimConfig() {
        ...
        this.K_SWERVE_DRIVETRAIN_CONFIG = new SwerveDrivetrainConfig(
                4,
                3.5,
                3.7,
                12,
        ...
        kDRIVE_FF_POINTS.add(new double[] {
                this.K_SWERVE_DRIVETRAIN_CONFIG.kMAX_DRIVETRAIN_TRANSLATIONAL_VELOCITY_METERS_PER_SEC / 2, 0, 0 });
        kDRIVE_FF_POINTS
        ...
        this.K_SWERVE_DRIVETRAIN_CONTROLLER_CONFIG = new SwerveControllerConfig(
                kDRIVE_FF_POINTS,
