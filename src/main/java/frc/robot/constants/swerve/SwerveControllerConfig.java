...
public class SwerveControllerConfig {
    ...
    public final double kROTATIONAL_POSITION_MAX_OUTPUT_RAD_SEC;
    ...
    public SwerveControllerConfig(
        ...
        double rotationalPositionMaxOutputRadSec) {
        ...
        this.kROTATIONAL_POSITION_MAX_OUTPUT_RAD_SEC = rotationalPositionMaxOutputRadSec;
    }
}
