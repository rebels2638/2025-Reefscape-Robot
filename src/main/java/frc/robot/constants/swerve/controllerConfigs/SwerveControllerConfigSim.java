...
public class SwerveControllerConfigSim extends SwerveControllerConfigBase {
    
    public static SwerveControllerConfigSim instance = null;
    public static SwerveControllerConfigSim getInstance() {
        if (instance == null) {
            instance = new SwerveControllerConfigSim(0);
        }
        return instance;
    }
     ...
     */
    private SwerveControllerConfigSim(double maxAngularVelocityRadiansPerSec) {
